      ...
      <nav className={`fixed w-full z-[100] transition-all duration-500 px-6 py-4 ${
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            <a href="/Login" className="bg-secondary text-black px-6 py-2 rounded-full font-black text-[10px] uppercase tracking-widest hover:scale-105 transition-transform">
              Join Community
            </a>
          </div>
        </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/Login" className="border border-white/20 px-10 py-4 rounded-full font-black uppercase text-xs tracking-widest hover:bg-white/10 transition-all">Write a Review</a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-secondary p-10 rounded-[2.5rem] flex items-center justify-between group">
              ...
              <a href="/Login" className="w-16 h-16 bg-black text-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
